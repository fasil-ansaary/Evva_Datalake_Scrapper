...
class Community_resource_scrapper:
    ...
    def community_resource_scrapper(self):        
        ...
        scrapping_url = "https://www.communityresourcefinder.org/ProviderSearch/Search?ProfileDefinitionId=64&location="
        care_type = "Transportation"
    ...
    def com_res_url_scrapper(self, url, program_name):
        ...
        while s < length:
            ...
            try:            
                ...
                self.pricing.append(suuport__grp_info)
            except:
                # print("nil")
                self.pricing.append("nil")
