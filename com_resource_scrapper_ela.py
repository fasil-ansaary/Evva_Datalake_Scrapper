...
class Community_resource_scrapper:
    ...
    def com_res_url_scrapper(self, url, program_name, zip, csv_path):
        ...
        while s < length:
                ...
                # General Information
                try:       
                    general_info = soup.find("div", id= "tabS2P15").get_text(strip=True, separator=' ')
                ...
                try:            
                    # Staff Information
                    staff_info = soup.find("div", id= "tabS3P15").get_text(strip=True, separator=' ')
                ...
                try:            
                    # Services Offered
                    services_info= soup.find("div",id= "tabS6P15").get_text(strip=True, separator=' ')
                ...
                try:    
                    ...
                    pricing_availability_info = soup.find("div", id= "tabS9P15").get_text(strip=True, separator=' ')
                ...
                try:
                    ...
                    experiences = soup.find("div", id= "tabS8P15").get_text(strip=True, separator=' ')
                    self.experiences_data.append(experiences)
                except:
                    self.experiences_data.append("nil")   
                try:
                    # Financial Information
                    financial_info = soup.find("div", id= "tabS4P15").get_text(strip=True, separator=' ')
                ...
                try:
                    # Availability
                    availability_info = soup.find("div", id= "tabS5P15").get_text(strip=True, separator=' ')
                    self.availability_information_data.append(availability_info)
                except:
                    self.availability_information_data.append("nil")
                # try:
                #     overview_info = soup.find("div", id= "tabP156").get_text(strip=True, separator=' ')
